...
public class AudioGuideDataProvider {
    ...
    private static final AudioGuide[] audioguides = new AudioGuide[]{
            ...
            new AudioGuide(0,"Calle de las Mercedes", "Información general", R.mipmap.calle,R.raw.audio_tower_clock),
            new AudioGuide(1,"Castillo de Bocachica", "Información general", R.mipmap.castillo,R.raw.audio_tower_clock),
            new AudioGuide(2,"Plaza de los coches", "Información general", R.mipmap.plaza_de_los_coches,R.raw.audio_tower_clock),
            new AudioGuide(3,"Torre del reloj", "Información general", R.mipmap.torre_del_reloj,R.raw.audio_tower_clock),
            ...
            new AudioGuide(16,"Palacio de la inquisicion", "Información general", R.mipmap.palacio_de_la_inquisicion,R.raw.audio_tower_clock),
