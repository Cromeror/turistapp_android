...
//            ).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (intent.getDoubleExtra(POSITION_LAT, 0d)
            ...
            ubicationCamera(new LatLng(intent.getDoubleExtra(POSITION_LAT, 0),
                    intent.getDoubleExtra(POSITION_LON, 0)));
        /*else
            getLocation();*/
    ...
    public void onLocationChanged(Location location) {
        ...
        ubicationCamera(new LatLng(location.getLatitude(), location.getLongitude()));
